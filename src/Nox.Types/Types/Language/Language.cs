...
public class Language : ValueObject<string, Language>
{
    ...
    internal override ValidationResult Validate()
    {
        ...
        {
            result.Errors.Add(new ValidationFailure(nameof(Value), $"Could not create a Nox Text type that is {Value.Length} characters long and longer than the maximum specified length of {_languageTypeOptions.MaxLangValue}"));
        }
