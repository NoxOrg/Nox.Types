...
public class LanguageTests
{
    ...
    public void Language_Constructor_SpecifyingMaxLength_WithLongerLengthInput_ThrowsValidationException()
    {
        ...
        action.Should().Throw<TypeValidationException>()
            .And.Errors.Should().BeEquivalentTo(new[] { new ValidationFailure("Value", "Could not create a Nox Text type that is 6 characters long and longer than the maximum specified length of 3") });
    }
